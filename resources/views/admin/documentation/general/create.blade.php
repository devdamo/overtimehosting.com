<x-app-layout>
    <div class="container mx-auto py-8">
        <h1 class="text-2xl font-bold mb-4">Create General Article</h1>

        <form action="{{ route('admin.general-articles.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-4">
            ...
            <div class="mb-4">
                <label for="markdown_body" class="block text-gray-700">Markdown Body:</label>
                <textarea name="markdown_body" id="markdown_body" rows="10" class="w-full border border-gray-300 rounded p-2" required></textarea>
            </div>
            <div class="mb-4">
